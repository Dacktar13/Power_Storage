...
public class Strings {
    ...
    public static final String INVALID_FINGERPRINT_MESSAGE = "The copy of Power Storage that you are running has been modified from the original, and unpredictable things may happen. Please consider re-downloading the original version of the mod.";
...
//    public static final String NBT_TE_DIRECTION_KEY = "teDirection";
    ...
    public static final String MERCURY_ORE_NAME = "mercuryOre";
    public static final String MERCURY_LIQUID_MOVING_NAME = "mercuryLiquidMoving";
    public static final String MERCURY_LIQUID_STILL_NAME = "mercuryLiquidStill";
    public static final String BATTERTY_BOX_NAME = "batteryBox";
    ...
    public static final String MERCURY_INGOT_NAME = "mercuryIngot";
    public static final String BUCKET_MERCURY_NAME = "bucketMercury";
